...
def migrate():
    ...
    with engine.connect() as conn:
        ...
        for column_name, column_type in [
            ...
            ("entry_confirmation_runs_required", "INTEGER"),
            ("reentry_no_flip_minutes", "INTEGER"),
            ("same_day_no_rebuy_minutes", "INTEGER"),
            ("trailing_warmup_minutes", "INTEGER"),
            ("trailing_min_favorable_move_pct", "REAL"),
